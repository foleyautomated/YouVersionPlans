...
namespace ABS.UVPlans
{
    ...
    {
        private Lazy<global::ABS.UVPlans.WorkflowRunnerService> _workflowRunnerServiceLazy;
        ...
        public CodedWorkflow()
        {
            ...
            _workflowRunnerServiceLazy = new Lazy<global::ABS.UVPlans.WorkflowRunnerService>(() => new global::ABS.UVPlans.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected global::ABS.UVPlans.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
